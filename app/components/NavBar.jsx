    ...
    <div className='px-8'>
        <div className='flex items-center justify-between py-4 relative'>
            ...
            <div className='flex items-center md:space-x-10 lg:space-x-20'>
                <div className="font-extrabold text-2xl text-green-700"><a href="/">KCF SHOP</a></div>
                ...
                <nav className='max-md:hidden'>
                    <ul className='flex items-center lg:space-x-10 space-x-7 opacity-70 text-[15px]'>
                        <li onClick={() => setActiveItem(1)}><a href="/" className={`py-3 inline-block font-semibold ${activeItem===1 ? 'text-green-950' : "text-gray-700"} w-full`}>HOME</a></li>
                        <li onClick={() => setActiveItem(2)}><a href="/products" className={`py-3 font-semibold ${activeItem===2 ? 'text-green-950' : "text-gray-700"} inline-block w-full`}>SHOP</a></li>
                        <li onClick={() => setActiveItem(3)}><a href="/blogs" className={`py-3 font-semibold ${activeItem===3 ? 'text-green-950' : "text-gray-700"} inline-block w-full`}>BLOG</a></li>
                        <li onClick={() => setActiveItem(4)}><a href="/contact" className={`py-3 font-semibold ${activeItem===4 ? 'text-green-950' : "text-gray-700"} inline-block w-full`}>CONTACT</a></li>
